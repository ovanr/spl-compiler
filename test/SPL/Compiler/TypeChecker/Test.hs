...
test_unify = do
    let tests = [
            ...
            ~* [("c", TCTTupleType def (TCTIntType def) (TCTVarType def "a")), ("b", TCTFunType def [] (TCTIntType def) (TCTBoolType def))],

            -- U( a -> a, c -> d ) = [ a |-> d, c |-> d ]
            (TCTFunType def [] (TCTVarType def "a") (TCTVarType def "a"), TCTFunType def [] (TCTVarType def "c") (TCTVarType def "d"))
            ...
            ~* [("d", TCTTupleType def (TCTVarType def "b") (TCTVarType def "b")), 
                ("c", TCTFunType def [] (TCTTupleType def (TCTVarType def "b") (TCTVarType def "b")) (TCTTupleType def (TCTVarType def "b") (TCTVarType def "b")))],

            -- U( a, (b, a) ) = fail
            failure (TCTVarType def "a", TCTTupleType def (TCTVarType def "b") (TCTVarType def "a")),

            -- U( a -> b -> b -> c, a -> d -> d) = fail
            failure (TCTFunType def [] (TCTVarType def "a") (TCTFunType def [] (TCTVarType def "b") (TCTFunType def [] (TCTVarType def "b") (TCTVarType def "c"))),
